...
public class Client {
	...
	private int actual_residential_city_id;
	...
	public java.util.Date getBirthday_date(){
	...
	public java.util.Date getPassport_issue_date(){
		return passport_issue_date;
	}

	public void setPassport_issue_date(java.util.Date passport_issue_date){
	...
	public int getActual_residential_city_id(){
		return actual_residential_city_id;
	}

	public void setActual_residential_city_id(int actual_residential_city_id){
		this.actual_residential_city_id=actual_residential_city_id;
	}
